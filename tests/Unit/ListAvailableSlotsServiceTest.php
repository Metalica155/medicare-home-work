...
class ListAvailableSlotsServiceTest extends TestCase
{
    ...
    public function test_returns_generated_slots_for_a_single_availability(): void
    {
        ...
        $slot1 = $this->makeSlot($availability, '2026-07-01 09:30:00', '2026-07-01 10:00:00');
        $slot2 = $this->makeSlot($availability, '2026-07-01 10:00:00', '2026-07-01 10:30:00');
    ...
    public function test_returns_filtered_slots_for_a_single_availability(): void
    {
        ...
        $generatedSlots = collect(
            [
                $this->makeSlot($availability, '2026-07-01 09:30', '2026-07-01 10:00'),
                $this->makeSlot($availability, '2026-07-01 10:00', '2026-07-01 10:30'),
            ]
        );
